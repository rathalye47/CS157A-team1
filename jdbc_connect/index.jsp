      ...
      <%@ page import="java.nio.file.*" %>
        ...
        ">
              ...
              Class.forName("com.mysql.cj.jdbc.Driver");
                ...
                <% if(request.getParameter("uploadVideo") !=null){ String
                  videoTitle=request.getParameter("uploadVideo"); String fromFile=File.separator + "Users" +
                  File.separator + "supernova" + File.separator + "Downloads" + File.separator + videoTitle; String
                  toFile=File.separator + "Users" + File.separator + "supernova" + File.separator + "Documents" +
                  File.separator + "Coding" + File.separator + "All Classes" + File.separator + "CS157A" +
                  File.separator + "apache-tomcat-10.0.23" + File.separator + "webapps" + File.separator + "ROOT" +
                  File.separator + "public" + File.separator + "videos" + File.separator + videoTitle; Path
                  source=Paths.get(fromFile); Path target=Paths.get(toFile); try { Files.copy(source, target,
                  StandardCopyOption.REPLACE_EXISTING); Class.forName("com.mysql.cj.jdbc.Driver"); int
                  user_id=(int)session.getAttribute("user_id"); String db="feedmeup" ; Connection
                  con=DriverManager.getConnection("jdbc:mysql://localhost:3306/" + db,"root","root"); Statement
                  stmt=con.createStatement(); 
                  
                  
                  
                  int random_int=(int)Math.floor(Math.random()*(2000000-500+1)+500); String
                  statement2="INSERT INTO feedmeup.Videos (video_id, title, file_path, duration, views, video_resolution, language, user_id) VALUES (null,'Banana Soup with Cold Noodle',"
                  + "'" + videoTitle + "','1:15', " + Integer.toString(random_int) +", '1080p' , 'EN' ," +
